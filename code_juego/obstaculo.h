...
public:
    ...
    // El nivel o el controlador deben ajustar los límites según el tamaño de la escena.
    ...
    // Colisión caja contra caja con cualquier Personaje (Soldado, Tanque, Avion, Enemigo).
